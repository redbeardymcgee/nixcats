...
-- km.set("n", "<leader>gg", require("tsugit").toggle(),
--   { noremap = true, silent = false, desc = "Lazygit" })
-- km.set("n", "<leader>gf",
--   function()
--     require("tsugit").toggle_for_file(vim.api.nvim_buf_get_name(0))
--   end,
--   { noremap = true, silent = false, desc = "Lazygit file commits" })
